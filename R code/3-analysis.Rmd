...
unstructured_data_use <- unnest_string_var(unstructured_data_use, "Unstructured_data_type")

p2 <- horizontal_bar(unstructured_data_use, 
...
print_multiple_items(data_unnested, "unstructured data types")
...
## Data sources summary different ML paradigms
\newpage
```{r}
